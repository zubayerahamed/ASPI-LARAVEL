...
class ScreensSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('screens')->insert([
            ...
            ['xscreen' => 'MD07', 'title' => 'Product Options', 'icon' => 'ph ph-list-dashes', 'keywords' => 'product options', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 23],
            ['xscreen' => 'MD08', 'title' => 'Product Specification Groups', 'icon' => 'ph ph-folders', 'keywords' => 'specification groups', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 24],
            ['xscreen' => 'MD09', 'title' => 'Product Specification Attributes', 'icon' => 'ph ph-sliders', 'keywords' => 'product specs', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 25],
            ['xscreen' => 'MD10', 'title' => 'Product Specification Tables', 'icon' => 'ph ph-table', 'keywords' => 'spec tables', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 26],
