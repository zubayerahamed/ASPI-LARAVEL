...
class ScreensSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('screens')->insert([
            ...
            ['xscreen' => 'AD02', 'title' => 'Access Profile', 'icon' => 'ph ph-shield-check', 'keywords' => 'access,roles,permissions', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 3],
            ['xscreen' => 'AD03', 'title' => 'Manage Users', 'icon' => 'ph ph-users', 'keywords' => 'users,management', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 4],
            ['xscreen' => 'AD04', 'title' => 'Branch/Business Unit', 'icon' => 'ph ph-buildings', 'keywords' => 'branch,business unit', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 5],
            ['xscreen' => 'AD05', 'title' => 'Store/Warehouse', 'icon' => 'ph ph-warehouse', 'keywords' => 'store,warehouse,inventory', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 6],
            ['xscreen' => 'AD06', 'title' => 'Terminal', 'icon' => 'ph ph-monitor', 'keywords' => 'terminal,device,pos', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 7],
            ['xscreen' => 'AD07', 'title' => 'Floor', 'icon' => 'ph ph-grid-four', 'keywords' => 'floor,layout', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 8],
            ['xscreen' => 'AD08', 'title' => 'Table', 'icon' => 'ph ph-table', 'keywords' => 'table,dine,layout', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 9],
            ['xscreen' => 'AD09', 'title' => 'Phone Numbers', 'icon' => 'ph ph-phone', 'keywords' => 'phone,contact', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 10],
            ['xscreen' => 'AD10', 'title' => 'Opening Hours', 'icon' => 'ph ph-clock', 'keywords' => 'hours,time,settings', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 11],
            ['xscreen' => 'AD11', 'title' => 'Store Holiday', 'icon' => 'ph ph-calendar-minus', 'keywords' => 'holiday,calendar,store', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 12],
            ['xscreen' => 'AD12', 'title' => 'Charges', 'icon' => 'ph ph-receipt', 'keywords' => 'charges,fees', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 13],
            ['xscreen' => 'AD13', 'title' => 'Payment Methods', 'icon' => 'ph ph-credit-card', 'keywords' => 'payment,methods,transaction', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 14],
            ['xscreen' => 'AD14', 'title' => 'Transactions', 'icon' => 'ph ph-arrows-left-right', 'keywords' => 'transactions,records', 'type' => 'SCREEN', 'xnum' => 0, 'seqn' => 15],
