...
class MD03Controller extends ZayaanController
{
            ...
            if ($frommenu == 'Y') {
                ...
                if("RESET" != $id && is_numeric($id) && $id > 0) {
                    try {
                        ...
                        Log::error("MD03Controller index error: " . $th->getMessage());
                    }
                }
    ...
    public function create(Request $request)
    {
        ...
        if ($attribute) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('MD03', ['id' => 'RESET'])),
                new ReloadSection('header-table-container', route('MD03.header-table')),
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($attribute->save()) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('MD03', ['id' => $attribute->id])),
                new ReloadSection('header-table-container', route('MD03.header-table')),
            ]);
