...
class AD05Controller extends ZayaanController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ("RESET" == $id) {
                return response()->json([
                    'page' => view('pages.AD05.AD05-main-form', [
                        'term' => (new Term())->fill(['seqn' => 0, 'color' => '#ffffff', 'attribute_id' => $attribute_id]),
                        'attribute' => $attribute,
                    ])->render(),
                ]);
    ...
    public function create(Request $request)
    {
        ...
        if ($term) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('AD05', ['id' => 'RESET', 'attribute_id' => $request->input('attribute_id')])),
                new ReloadSection('header-table-container', route('AD05.header-table', ['attribute_id' => $request->input('attribute_id')])),
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($term) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('AD05', ['id' => $term->id, 'attribute_id' => $request->input('attribute_id')])),
                new ReloadSection('header-table-container', route('AD05.header-table', ['attribute_id' => $request->input('attribute_id')])),
            ]);
    ...
    public function delete(Request $request, $id)
    {
        ...
        $this->setReloadSections([
            new ReloadSection('main-form-container', route('AD05', ['id' => 'RESET', 'attribute_id' => $attribute_id])),
            new ReloadSection('header-table-container', route('AD05.header-table', ['attribute_id' => $attribute_id])),
        ]);
