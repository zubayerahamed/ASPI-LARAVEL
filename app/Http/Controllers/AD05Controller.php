...
class AD05Controller extends ZayaanController
{
    ...
    public function detailTable(Request $request)
    {
        ...
        return response()->json([
            'page' => view('pages.AD05.AD05-detail-table', [
    ...
    public function create(Request $request)
    {
        ...
        if ($profile) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('AD05', ['id' => $profile->id])),
                new ReloadSection('detail-table-container', route('AD05.detail-table', ['profile_id' => $profile->id])),
            ]);
    ...
    public function delete($id)
    {
        ...
        if ($profile->delete()) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('AD05', ['id' => 'RESET'])),
                new ReloadSection('detail-table-container', route('AD05.detail-table', ['profile_id' => 'RESET'])),
            ]);
