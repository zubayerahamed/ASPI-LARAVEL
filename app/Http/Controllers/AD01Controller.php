...
class AD01Controller extends ZayaanController
{
    ...
    public function create(Request $request)
    {
        ...
        if ($menu) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('AD01', ['id' => 'RESET'])),
                new ReloadSection('header-table-container', route('AD01.header-table')),
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($menu) {
            $this->setReloadSections([
                new ReloadSection('main-form-container', route('AD01', ['id' => $menu->id])),
                new ReloadSection('header-table-container', route('AD01.header-table')),
            ]);
