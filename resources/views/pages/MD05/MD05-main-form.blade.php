<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $tag->id == null ? route('MD05.create') : route('MD05.update', ['id' => $tag->id]) }}" method="POST">
            @csrf
            @if ($tag->id != null)
                @method('PUT')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1 text-left">
                    <button
                            ...
                            data-reloadurl="{{ route('MD05', ['id' => 'RESET']) }}"
                            data-detailreloadid="header-table-container"
                            data-detailreloadurl="{{ route('MD05.header-table') }}"
                            type="reset"
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('MD05.delete', ['id' => $tag->id]) }}" type="button" class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
