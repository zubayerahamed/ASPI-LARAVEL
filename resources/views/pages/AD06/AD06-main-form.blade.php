<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $user->id == null ? route('AD06.create') : route('AD06.update', ['id' => $user->id]) }}" method="POST">
            @csrf
            @if ($user->id != null)
                @method('PUT')
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('AD06.delete', ['id' => $user->id]) }}" type="button" class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
