@if (!$detailList->isEmpty())
    <div class="card card-default">
        ...
        <div class="table-responsive data-table-responsive">
            <table class="table table-hover table-bordered p-0 m-0 SA02-datatable-fragment">
                <thead>
                    <tr>
                        <th>Business Name</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            kit.ui.config.initDatatable('SA02-datatable-fragment');

            $('.SA02-datatable-fragment').on('click', 'a.detail-dataindex', function(e){
                e.preventDefault();
            ...
            $('.SA02-datatable-fragment').on('click', 'button.btn-table-delete', function(e){
                e.preventDefault();
                sweetAlertConfirm(() => {
