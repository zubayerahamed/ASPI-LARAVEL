<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $attribute->id == null ? route('MD03.create') : route('MD03.update', ['id' => $attribute->id]) }}" method="POST">
            @csrf
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1 text-left">
                    <button
                            ...
                            data-reloadurl="{{ route('MD03', ['id' => 'RESET']) }}"
                            data-detailreloadid="header-table-container"
                            data-detailreloadurl="{{ route('MD03.header-table') }}"
                            type="reset"
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('MD03.delete', ['id' => $attribute->id]) }}" type="button" class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
