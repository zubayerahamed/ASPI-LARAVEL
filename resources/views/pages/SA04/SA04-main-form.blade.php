                        ...
                        <div class="icon-picker-container">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i id="selectedIconPreview" class="{{ $screen->icon }}"></i></span>
                                </div>
                                <input type="text" class="form-control icon-input" name="icon" value="{{ $screen->icon }}">
