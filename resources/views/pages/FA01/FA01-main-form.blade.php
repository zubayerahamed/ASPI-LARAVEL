<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $acsub->id == null ? route('FA01.create') : route('FA01.update', ['id' => $acsub->id]) }}" method="POST">
            @csrf
            @if ($acsub->id != null)
                @method('PUT')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1 text-left">
                    <button
                            ...
                            data-reloadurl="{{ route('FA01', ['id' => 'RESET']) }}"
                            data-detailreloadid="header-table-container"
                            data-detailreloadurl="{{ route('FA01.header-table') }}"
                            type="reset"
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('FA01.delete', ['id' => $acsub->id]) }}" type="button" class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
