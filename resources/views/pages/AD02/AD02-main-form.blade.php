<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $profile->id == null ? route('AD02.create') : route('AD02.update', ['id' => $profile->id]) }}" method="POST">
            @csrf
            @if ($profile->id != null)
                @method('PUT')
                        ...
                        <div class="icon-picker-container">
                            <div class="input-group">
                                ...
                                <div class="input-group-append btn-search"
                                    ...
                                    data-mainreloadurl="{{ route('AD02', ['id' => '']) }}"
                                    data-mainreloadid="main-form-container"
                                    data-detailreloadurl="{{ route('AD02.detail-table', ['id' => 'RESET', 'profile_id' => '']) }}"
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1 text-left">
                    <button 
                        ...
                        data-detailreloadid="detail-table-container" 
                        data-detailreloadurl="{{ route('AD02.detail-table', ['id' => 'RESET', 'profile_id' => 'RESET']) }}"
                        type="reset" 
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('AD02.delete', ['id' => $profile->id]) }}" type="button"  class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
