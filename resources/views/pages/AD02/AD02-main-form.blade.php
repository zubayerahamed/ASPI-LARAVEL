<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $menu->id == null ? route('AD02.create') : route('AD02.update', ['id' => $menu->id]) }}" method="POST">
            @csrf
            @if ($menu->id != null)
                @method('PUT')
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('AD02.delete', ['id' => $menu->id]) }}" type="button" class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
