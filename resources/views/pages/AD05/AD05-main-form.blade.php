<div class="card card-default">
    <div class="card-body">
        <form id="mainform" action="{{ $term->id == null ? route('AD05.create') : route('AD05.update', ['id' => $term->id]) }}" method="POST">
            @csrf
            @if ($term->id != null)
                @method('PUT')
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="flex-grow-1 text-left">
                    <button
                            ...
                            data-reloadurl="{{ route('AD05', ['id' => 'RESET', 'attribute_id' => $term->attribute_id]) }}"
                            data-detailreloadid="header-table-container"
                            data-detailreloadurl="{{ route('AD05.header-table', ['attribute_id' => $term->attribute_id]) }}"
                            type="reset"
                ...
                <div class="flex-grow-1 justify-content-end d-flex gap-2">
                    ...
                    @else
                        <button data-url="{{ route('AD05.delete', ['id' => $term->id]) }}" type="button" class="btn btn-sm btn-danger btn-delete d-flex align-items-center gap-2">
