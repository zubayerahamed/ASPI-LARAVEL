...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'assets/images/aspi_black.png',
            'alt' => 'ASPI',
            'class' => '',
            'width' => 150,
            'height' => 50,
    ...
    */
    ...
    'preloader' => [
        ...
        'mode' => 'fullscreen',
        'img' => [
            'path' => 'assets/images/aspi_logo_black.png',
            'alt' => 'ASPI Preloader Image',
        ...
        'PhosphorIcons' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => 'https://cdn.jsdelivr.net/npm/@phosphor-icons/web@2.1.1/src/regular/style.css',
                ],
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => 'https://cdn.jsdelivr.net/npm/@phosphor-icons/web@2.1.1/src/fill/style.css',
                ],
            ],
        ],
        'Datatables' => [
        ...
        'cropper' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.6/cropper.css',
                ],
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.6/cropper.js',
                ],
            ]
        ],
        'colorpicker' => [
        ...
        'Dropzone' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/dropzone/css/dropzone.css',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/dropzone/css/basic.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/dropzone/js/dropzone-min.js',
                ],
            ]
        ],
        'Summernote' => [
        ...
        'Smoke' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'vendor/smoke/css/smoke.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/smoke/js/smoke.js',
                ],
            ]
        ],
        'Typeahead' => [
